...
import 'package:mybarterit/views/screens/loginscreen.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                  ...
                                  child: const Text("Register", style: TextStyle(color: Colors.black,)),  style: ButtonStyle(
  ...
  void registerUser() {
    ...
    http.post(Uri.parse("${MyConfig().SERVER}/mybarterit/php/register.php"),
        body: {
          "name": name,"email": email,"phone": phone,"password": passa,
        }).then((response) {
